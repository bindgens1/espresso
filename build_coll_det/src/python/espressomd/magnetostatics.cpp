...
#endif
{
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "handle_errors", (void (**)(void))&__pyx_f_10espressomd_5utils_handle_errors, "PyObject *(PyObject *, int __pyx_skip_dispatch)") < 0) __PYX_ERR(1, 1, __pyx_L1_error)
